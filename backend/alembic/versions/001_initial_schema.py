...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('type', sa.Enum('Application', 'Microservice', 'Database', 'Container', 'Infrastructure', 'Server', 'Network', 'Cloud', name='assettype'), nullable=False),
        sa.Column('classification_level', sa.Enum('Public', 'Internal', 'Confidential', 'Restricted', name='classificationlevel'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('relationship_type', sa.Enum('depends_on', 'communicates_with', 'processes_data_from', name='relationshiptype'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('stride_category', sa.Enum('Spoofing', 'Tampering', 'Repudiation', 'Info_Disclosure', 'DoS', 'Elevation', name='stridecategory'), nullable=True),
        ...
        sa.Column('status', sa.Enum('Identified', 'Assessed', 'Verified', 'Evaluated', 'Planning', 'Mitigated', 'Accepted', 'Monitoring', name='threatstatus'), nullable=False, server_default='Identified'),
    ...
    op.create_table(
        ...
        sa.Column('from_state', sa.Enum('Identified', 'Assessed', 'Verified', 'Evaluated', 'Planning', 'Mitigated', 'Accepted', 'Monitoring', name='threatstatus'), nullable=False),
        sa.Column('to_state', sa.Enum('Identified', 'Assessed', 'Verified', 'Evaluated', 'Planning', 'Mitigated', 'Accepted', 'Monitoring', name='threatstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('asset_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('scanner_type', sa.Enum('SAST', 'DAST', 'SCA', 'IaC', name='scannertype'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('Open', 'In_Progress', 'Remediated', 'False_Positive', 'Accepted', name='findingstatus'), nullable=False, server_default='Open'),
    ...
    op.create_table(
        ...
        sa.Column('framework', sa.Enum('NIST_800_53', 'ISO_27001', 'PCI_DSS', 'HIPAA', 'GDPR', name='complianceframework'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('severity', sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', name='policyseverity'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('policy_rule_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('gate_decision', sa.Enum('Pass', 'Warn', 'Block', name='gatedecision'), nullable=False),
